...
class VOXNOT:
    """
    Класс представляющий верхнеуровневое API для работы с алгоритмом XNOT в части аудио. 

    Предоставляет верхнеуровневые методы тренировки моделей с разными параметрами
    и методы использования посчитанных моделей для voice-конвертации реальных данных в целевые голоса
